...
- `MidpointPlannerNode._tentative_cone_is_usable_for_planning` in `sim_car/sim_car/planning/midpoint_planner_node.py`: gate for whether tentative tracks may contribute to planning.
...
- `MidpointPlannerNode._update_midline_buffer` in `sim_car/sim_car/planning/midpoint_planner_node.py`: maintains the recent-path buffer used to stabilize updates.
