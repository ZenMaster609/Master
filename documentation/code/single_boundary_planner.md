...
- `_deterministic_order` in `sim_car/sim_car/planning/planner_utils.py`: creates a stable candidate ordering.
...
- `_finalize_path` in `sim_car/sim_car/planning/planner_utils.py`: smooths and resamples the candidate path before validation.
