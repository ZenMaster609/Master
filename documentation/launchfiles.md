...
- `vehicleModel` (default: `DynamicBicycle`)
- `vehicleModelConfig` (default: `configDry.yaml`)
- `commandMode` (default: `acceleration`)
- `robot_name` (default: `eufs`)
- `gazebo_gui` (default: `false`)
- `rviz` (default: `true`)
- `publish_gt_tf` (default: `false`)
- `pub_ground_truth` (default: `true`)
- `launch_group` (default: `default`)

### `eufs_sim/eufs_launcher/launch/eufs_launcher.launch.py`

- `config` (default: `eufs_sim/eufs_launcher/config/eufs_launcher.yaml`)
- `gui` (default: `true`)
...
- `launch_group` (default: `default`)
- `rviz` (default: `false`)
- `show_rqt_gui` (default: `true`)
- `namespace` (default: `eufs`)
- `robot_name` (default: `eufs`)
- `vehicleModel` (default: `DynamicBicycle`)
- `commandMode` (default: `acceleration`)
- `vehicleModelConfig` (default: `configDry.yaml`)
